...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@xx.xxxx.xxxxx";
    ...
    * @var string
    */
	protected $baseDn = "DC=xx,DC=xxxx,DC=xxxxx";
    ...
    * @var array
    */
    protected $domainControllers = array("xxx-xxx.xx.xxxx.xxxxx");
    ...
    * @var string
    */
	protected $adminUsername = "username";
    ...
    */
    public function connect() 
    {
        ...
        $domainController = "192.168.207.250";//$this->randomController();
        if ($this->useSSL) {
